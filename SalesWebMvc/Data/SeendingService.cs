...
namespace SalesWebMvc.Data
{
    public class SeendingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Carlos Alberto", "carlos@gmail.com", new DateTime(1988, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Santos", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Pedro Junior", "pedro@gmail.com", new DateTime(1990, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Marta Lima", "marta@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Davi Correia", "davi@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Roberto Silva", "roberto@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
